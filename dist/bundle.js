...
/***/ function(module, exports, __webpack_require__) {
	...
	var _workshop = __webpack_require__(299);

	var _marked = [branch].map(regeneratorRuntime.mark);

	var ws = new _workshop.WorkShop('#fractal');
	var len = 100;
	var rate = .67;
	var angel = Math.PI / 10;
	...
	function branch(len) {
	  return regeneratorRuntime.wrap(function branch$(_context) {
	    while (1) {
	      switch (_context.prev = _context.next) {
	        ...
	        case 4:
	          ...
	          ws.stroke('#f00');
	          ws.rotate(angel);
	          return _context.delegateYield(branch(len * rate), 't0', 9);
	        ...
	        case 9:
	          ...
	          ws.stroke('#fff');
	          ws.rotate(-angel);
	          return _context.delegateYield(branch(len * rate), 't1', 14);
